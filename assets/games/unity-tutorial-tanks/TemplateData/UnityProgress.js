function UnityProgress (dom) {
	...
	logoImage.src = "/assets/games/unity-tutorial-tanks/TemplateData/Logo." + splashStyle + ".png";
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "/assets/games/unity-tutorial-tanks/TemplateData/ProgressFrame." + splashStyle + ".png";
	...
	progressBarImg.src = "/assets/games/unity-tutorial-tanks/TemplateData/ProgressBar." + splashStyle + ".png";
