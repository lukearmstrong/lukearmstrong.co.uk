function UnityProgress (dom) {
	...
	logoImage.src = "/assets/games/unity-tutorial-space-shooter/TemplateData/Logo." + splashStyle + ".png";
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "/assets/games/unity-tutorial-space-shooter/TemplateData/ProgressFrame." + splashStyle + ".png";
	...
	progressBarImg.src = "/assets/games/unity-tutorial-space-shooter/TemplateData/ProgressBar." + splashStyle + ".png";
